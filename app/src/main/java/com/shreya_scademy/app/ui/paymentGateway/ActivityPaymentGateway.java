package com.shreya_scademy.app.ui.paymentGateway;
...
import com.shreya_scademy.app.model.ModelSettingRecord;
...
public class ActivityPaymentGateway extends BaseActivity implements View.OnClickListener {
    ImageView ivBack;
